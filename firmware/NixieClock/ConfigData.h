...
class ConfigData : IotWebConf
{
  public:
    ConfigData(String thingName, String wifiInitialApPassword, String Version, DNSServer &dnsServer, WebServer &server);
  ...
  private:
    const String thngName;
    const String passwrd;
